layui.config({base: "demo/js/"}).use(["main", "tabletree", "laypage", "form"], function () {
    var o = layui.jquery, m = layui.main, l = o(".table-list"), b = o(".handle-btn"), s = o(".content-search"),
        tb = "#tabletree", tp = "#table-pages";
